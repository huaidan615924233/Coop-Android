...
public class StatusBarCompat {
     ...
     */
    public static boolean setLightStatusBar(Window window){
        return LightStatusBarCompat.setLightStatusBar(window, true);
    }
     static void setStatusBarColorCompat(Activity activity,@ColorInt int color,@ColorInt int secondColor){
        if (setLightStatusBar(activity.getWindow())) {
            StatusBarCompat.setStatusBarColor(activity, color);
        }else{
            StatusBarCompat.setStatusBarColor(activity, secondColor);
        }
    }
    /**
     ...
     * @since 0.5.1
     */
    public static boolean setLightStatusBar(Window window, boolean isLightStatusBar) {
       return LightStatusBarCompat.setLightStatusBar(window, isLightStatusBar);
    }

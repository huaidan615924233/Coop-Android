...
class LightStatusBarCompat {
    ...
    interface ILightStatusBar {
         ...
         */
        boolean setLightStatusBar(Window window, boolean lightStatusBar);
    }
        ...
        if (MIUILightStatusBarImpl.isMe()) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                IMPL = new MLightStatusBarImpl() {
                    ...
                    @Override
                    public boolean setLightStatusBar(Window window, boolean lightStatusBar) {
    ...
    static boolean setLightStatusBar(Window window, boolean lightStatusBar) {
      return   IMPL.setLightStatusBar(window, lightStatusBar);
    }

...
//		tintManager.setStatusBarTintResource(R.drawable.title_background_gradient);//状态背景色，可传drawable资源
        // 状态栏沉浸，4.4+生效 >>>>>>>>>>>>>>>>>
        ...
        if (sysVersion > Build.VERSION_CODES.JELLY_BEAN_MR2) {
            ...
            LinearLayout toptop = (LinearLayout) this.findViewById(R.id.lltopTop);

...
public class EnterTeamAdapter extends RecyclerView.Adapter<EnterTeamAdapter.FeedHolder> {

    private static final String TAG = "EnterTeamAdapter";
    private Context context;
    private List<EnterTeamBean> data;

    public EnterTeamAdapter(Context context, List<EnterTeamBean> data) {
    ...
    public void onBindViewHolder(FeedHolder holder, int position) {
        ...
        GlideUtils.loadImage(context, photourl, holder.memberHeaderImg, R.mipmap.default_enter_user_header);
    }

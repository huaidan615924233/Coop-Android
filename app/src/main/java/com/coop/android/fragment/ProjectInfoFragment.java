...
import com.coop.android.activity.AssetTeamListActivity;
import com.coop.android.activity.AssetWhiteListActivity;
...
public class ProjectInfoFragment extends BaseFragment implements View.OnClickListener {
    ...
    private TextView projectNameTV, projectTimeTV, tokenPerTV, projectTotalTV, tokenTotalTV, projectDescTV, projectMemberNameTV,
            expandTV, projectLabelTV, assetNameTV, assetTypeTV;
    ...
    public void initView() {
        assetId = ((TransDetailActivity) context).getAssetId();

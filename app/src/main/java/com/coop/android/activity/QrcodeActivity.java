...
public class QrcodeActivity extends CBaseActivity {
    ...
    public void initView() {
        tvBaseTitle.setText(getString(R.string.txt_title_qrcode));
    ...
    public void initData() {
        ...
        mBitmap = CodeUtils.createImage(textContent, DensityUtil.dp2px(mContext, 111), DensityUtil.dp2px(mContext, 111), BitmapFactory.decodeResource(getResources(), R.mipmap.ic_launcher));

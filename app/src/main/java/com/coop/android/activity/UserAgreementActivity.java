...
public class UserAgreementActivity extends CBaseActivity {
    ...
    public void initView() {
        aboutUs = "欢迎您使用CO-OP！\n" +
                ...
                "1.8 BP：商业计划书。\n" +
                "1.9 价值通证：CO-OP利用区块链技术对于每个项目单独生成、记录、存储的数字化资产标示，每一数字化资产对应权利和规则依据CO-OP与项目签订的协议为准。\n" +
                "\n" +
                "二、协议当事人\n" +
                ...
                "3.6 CO-OP保留协作者在收到价值通证后进行二次交易时收取相关手续费用的权利。\n" +
                "3.7 CO-OP项目上线后资料将在平台中永久保留。项目正常终止（包括但不限于上市、并购、回购或清算）或异常终止（包括但不限于项目违反平台规则，项目违反法律或存在其他风险）CO-OP平台将依约定或相关法律负责价值通证后续清算工作。\n" +
                "\n" +
                "四、注册使用\n" +
                ...
                "5.7 创业者与协作者达成交易基于平等互利原则，由协作者提供创业者所需资源或提供包括但不限于智力、体力、行为等协助，由创业者支付经平台认定的价值通证作为酬劳。但创业者与协作者不得进行价值通证与现金交易行为。\n" +

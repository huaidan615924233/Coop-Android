 ...
 */
public class EnterTransBean implements Parcelable {
    ...
    public EnterTransBean() {
    }

    protected EnterTransBean(Parcel in) {
    ...
    public static final Creator<EnterTransBean> CREATOR = new Creator<EnterTransBean>() {
        @Override
        public EnterTransBean createFromParcel(Parcel in) {
            return new EnterTransBean(in);
        }

        @Override
        public EnterTransBean[] newArray(int size) {
            return new EnterTransBean[size];
        }
    };
